...
# <Scene {'id': 's_day2', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_day2:
    ...
    # Pass (assets)
    # <Events {} events ''>
    # <ParallelEvent {'auto': 'true', 'name': 'day2initialize'} ParallelEvent ''>
    ...
    # <ParallelEvent {'auto': 'true', 'name': '_6'} ParallelEvent ''>
    # <Events {} events ''>
    ...
    # <ParallelEvent {'auto': 'true', 'name': 'day2prechoice'} ParallelEvent ''>
    ...
    label s_day2_albatros:
        # <Macro {'name': 'albatros'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_albatros_day1} && !${scene:picked_once_albatros}', 'name': '_0', 'path': 'albatros/didEventFirst'} BranchMacro ''>
        if slot_picked_albatros_day1 and not scene_picked_once_albatros:
            jump s_day2_albatros_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_albatros_day1} &&  ${scene:picked_once_albatros}', 'name': '_1', 'path': 'albatros/didEventLoop'} BranchMacro ''>
        if slot_picked_albatros_day1 and  scene_picked_once_albatros:
            jump s_day2_albatros_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_albatros_day1} && !${scene:picked_once_albatros}', 'name': '_2', 'path': 'albatros/didntEventFirst'} BranchMacro ''>
        if not slot_picked_albatros_day1 and not scene_picked_once_albatros:
            jump s_day2_albatros_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_albatros_day1} &&  ${scene:picked_once_albatros}', 'name': '_3', 'path': 'albatros/didntEventLoop'} BranchMacro ''>
        if not slot_picked_albatros_day1 and  scene_picked_once_albatros:
            jump s_day2_albatros_didntEventLoop
        # <Macro {'name': 'didEventFirst'} Macro ''>
        ...
        label s_day2_albatros_didEventLoop:
            ...
            jump s_day2_albatros_cleanup
        # <Macro {'name': 'didntEventFirst'} Macro ''>
        label s_day2_albatros_didntEventFirst:
            ...
            jump s_day2_albatros_cleanup
        # <Macro {'name': 'didntEventLoop'} Macro ''>
        label s_day2_albatros_didntEventLoop:
            ...
            label s_day2_albatros_didntEventLoop_warm:
                ...
                show i_cousin_default_neutral as cousin zorder 2:
                    ...
                    linear 0.5 alpha 1.0
                $ renpy.pause(0.5) # TimedPause
            # <ParallelEvent {'allowInterrupt': 'false', 'name': '_1'} ParallelEvent ''>
            # <Events {} events ''>
            show i_cousin_default_neutral as cousin
            show i_albatross_toocool_smirk_wink as albatros:
                # ShowWithAtl
    ...
    label s_day2_amazona:
        # <Macro {'name': 'amazona'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_amazona_day1} && !${scene:picked_once_amazona}', 'name': '_0', 'path': 'amazona/didEventFirst'} BranchMacro ''>
        if slot_picked_amazona_day1 and not scene_picked_once_amazona:
            jump s_day2_amazona_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_amazona_day1} &&  ${scene:picked_once_amazona}', 'name': '_1', 'path': 'amazona/didEventLoop'} BranchMacro ''>
        if slot_picked_amazona_day1 and  scene_picked_once_amazona:
            jump s_day2_amazona_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_amazona_day1} && !${scene:picked_once_amazona}', 'name': '_2', 'path': 'amazona/didntEventFirst'} BranchMacro ''>
        if not slot_picked_amazona_day1 and not scene_picked_once_amazona:
            jump s_day2_amazona_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_amazona_day1} &&  ${scene:picked_once_amazona}', 'name': '_3', 'path': 'amazona/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_antibravo:
        # <Macro {'name': 'antibravo'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_antibravo_day1} && !${scene:picked_once_antibravo}', 'name': '_0', 'path': 'antibravo/didEventFirst'} BranchMacro ''>
        if slot_picked_antibravo_day1 and not scene_picked_once_antibravo:
            jump s_day2_antibravo_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_antibravo_day1} &&  ${scene:picked_once_antibravo}', 'name': '_1', 'path': 'antibravo/didEventLoop'} BranchMacro ''>
        if slot_picked_antibravo_day1 and  scene_picked_once_antibravo:
            jump s_day2_antibravo_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_antibravo_day1} && !${scene:picked_once_antibravo}', 'name': '_2', 'path': 'antibravo/didntEventFirst'} BranchMacro ''>
        if not slot_picked_antibravo_day1 and not scene_picked_once_antibravo:
            jump s_day2_antibravo_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_antibravo_day1} &&  ${scene:picked_once_antibravo}', 'name': '_3', 'path': 'antibravo/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_bluemax:
        # <Macro {'name': 'bluemax'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_bluemax_day1} && !${scene:picked_once_bluemax}', 'name': '_0', 'path': 'bluemax/didEventFirst'} BranchMacro ''>
        if slot_picked_bluemax_day1 and not scene_picked_once_bluemax:
            jump s_day2_bluemax_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_bluemax_day1} &&  ${scene:picked_once_bluemax}', 'name': '_1', 'path': 'bluemax/didEventLoop'} BranchMacro ''>
        if slot_picked_bluemax_day1 and  scene_picked_once_bluemax:
            jump s_day2_bluemax_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_bluemax_day1} && !${scene:picked_once_bluemax}', 'name': '_2', 'path': 'bluemax/didntEventFirst'} BranchMacro ''>
        if not slot_picked_bluemax_day1 and not scene_picked_once_bluemax:
            jump s_day2_bluemax_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_bluemax_day1} &&  ${scene:picked_once_bluemax}', 'name': '_3', 'path': 'bluemax/didntEventLoop'} BranchMacro ''>
        ...
        label s_day2_cousin_wrapper:
            ...
            if scene_doneExplore:
                ...
                label s_day2_cousin_wrapper_bail:
                    ...
                    # <NHSceneChange {'name': '_2', 'scene': 's_day2.5'} NHSceneChange ''>
    ...
    label s_day2_davesprite:
        # <Macro {'name': 'davesprite'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_davesprite_day1} && !${scene:picked_once_davesprite}', 'name': '_0', 'path': 'davesprite/didEventFirst'} BranchMacro ''>
        if slot_picked_davesprite_day1 and not scene_picked_once_davesprite:
            jump s_day2_davesprite_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_davesprite_day1} &&  ${scene:picked_once_davesprite}', 'name': '_1', 'path': 'davesprite/didEventLoop'} BranchMacro ''>
        if slot_picked_davesprite_day1 and  scene_picked_once_davesprite:
            jump s_day2_davesprite_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_davesprite_day1} && !${scene:picked_once_davesprite}', 'name': '_2', 'path': 'davesprite/didntEventFirst'} BranchMacro ''>
        if not slot_picked_davesprite_day1 and not scene_picked_once_davesprite:
            jump s_day2_davesprite_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_davesprite_day1} &&  ${scene:picked_once_davesprite}', 'name': '_3', 'path': 'davesprite/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_donko:
        # <Macro {'name': 'donko'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_donko_day1} && !${scene:picked_once_donko}', 'name': '_0', 'path': 'donko/didEventFirst'} BranchMacro ''>
        if slot_picked_donko_day1 and not scene_picked_once_donko:
            jump s_day2_donko_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_donko_day1} &&  ${scene:picked_once_donko}', 'name': '_1', 'path': 'donko/didEventLoop'} BranchMacro ''>
        if slot_picked_donko_day1 and  scene_picked_once_donko:
            jump s_day2_donko_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_donko_day1} && !${scene:picked_once_donko}', 'name': '_2', 'path': 'donko/didntEventFirst'} BranchMacro ''>
        if not slot_picked_donko_day1 and not scene_picked_once_donko:
            jump s_day2_donko_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_donko_day1} &&  ${scene:picked_once_donko}', 'name': '_3', 'path': 'donko/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_galaga:
        # <Macro {'name': 'galaga'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_galaga_day1} && !${scene:picked_once_galaga}', 'name': '_0', 'path': 'galaga/didEventFirst'} BranchMacro ''>
        if slot_picked_galaga_day1 and not scene_picked_once_galaga:
            jump s_day2_galaga_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_galaga_day1} &&  ${scene:picked_once_galaga}', 'name': '_1', 'path': 'galaga/didEventLoop'} BranchMacro ''>
        if slot_picked_galaga_day1 and  scene_picked_once_galaga:
            jump s_day2_galaga_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_galaga_day1} && !${scene:picked_once_galaga}', 'name': '_2', 'path': 'galaga/didntEventFirst'} BranchMacro ''>
        if not slot_picked_galaga_day1 and not scene_picked_once_galaga:
            jump s_day2_galaga_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_galaga_day1} &&  ${scene:picked_once_galaga}', 'name': '_3', 'path': 'galaga/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_hiromi:
        # <Macro {'name': 'hiromi'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_hiromi_day1} && !${scene:picked_once_hiromi}', 'name': '_0', 'path': 'hiromi/didEventFirst'} BranchMacro ''>
        if slot_picked_hiromi_day1 and not scene_picked_once_hiromi:
            jump s_day2_hiromi_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_hiromi_day1} &&  ${scene:picked_once_hiromi}', 'name': '_1', 'path': 'hiromi/didEventLoop'} BranchMacro ''>
        if slot_picked_hiromi_day1 and  scene_picked_once_hiromi:
            jump s_day2_hiromi_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_hiromi_day1} && !${scene:picked_once_hiromi}', 'name': '_2', 'path': 'hiromi/didntEventFirst'} BranchMacro ''>
        if not slot_picked_hiromi_day1 and not scene_picked_once_hiromi:
            jump s_day2_hiromi_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_hiromi_day1} &&  ${scene:picked_once_hiromi}', 'name': '_3', 'path': 'hiromi/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_jane:
        # <Macro {'name': 'jane'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_jane_day1} && !${scene:picked_once_jane}', 'name': '_0', 'path': 'jane/didEventFirst'} BranchMacro ''>
        if slot_picked_jane_day1 and not scene_picked_once_jane:
            jump s_day2_jane_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_jane_day1} &&  ${scene:picked_once_jane}', 'name': '_1', 'path': 'jane/didEventLoop'} BranchMacro ''>
        if slot_picked_jane_day1 and  scene_picked_once_jane:
            jump s_day2_jane_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_jane_day1} && !${scene:picked_once_jane}', 'name': '_2', 'path': 'jane/didntEventFirst'} BranchMacro ''>
        if not slot_picked_jane_day1 and not scene_picked_once_jane:
            jump s_day2_jane_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_jane_day1} &&  ${scene:picked_once_jane}', 'name': '_3', 'path': 'jane/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_lolo:
        # <Macro {'name': 'lolo'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_lolo_day1} && !${scene:picked_once_lolo}', 'name': '_0', 'path': 'lolo/didEventFirst'} BranchMacro ''>
        if slot_picked_lolo_day1 and not scene_picked_once_lolo:
            jump s_day2_lolo_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_lolo_day1} &&  ${scene:picked_once_lolo}', 'name': '_1', 'path': 'lolo/didEventLoop'} BranchMacro ''>
        if slot_picked_lolo_day1 and  scene_picked_once_lolo:
            jump s_day2_lolo_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_lolo_day1} && !${scene:picked_once_lolo}', 'name': '_2', 'path': 'lolo/didntEventFirst'} BranchMacro ''>
        if not slot_picked_lolo_day1 and not scene_picked_once_lolo:
            jump s_day2_lolo_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_lolo_day1} &&  ${scene:picked_once_lolo}', 'name': '_3', 'path': 'lolo/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_meowkie:
        # <Macro {'name': 'meowkie'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_meowkie_day1} && !${scene:picked_once_meowkie}', 'name': '_0', 'path': 'meowkie/didEventFirst'} BranchMacro ''>
        if slot_picked_meowkie_day1 and not scene_picked_once_meowkie:
            jump s_day2_meowkie_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_meowkie_day1} &&  ${scene:picked_once_meowkie}', 'name': '_1', 'path': 'meowkie/didEventLoop'} BranchMacro ''>
        if slot_picked_meowkie_day1 and  scene_picked_once_meowkie:
            jump s_day2_meowkie_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_meowkie_day1} && !${scene:picked_once_meowkie}', 'name': '_2', 'path': 'meowkie/didntEventFirst'} BranchMacro ''>
        if not slot_picked_meowkie_day1 and not scene_picked_once_meowkie:
            jump s_day2_meowkie_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_meowkie_day1} &&  ${scene:picked_once_meowkie}', 'name': '_3', 'path': 'meowkie/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_mrdriller:
        # <Macro {'name': 'mrdriller'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_mrdriller_day1} && !${scene:picked_once_mrdriller}', 'name': '_0', 'path': 'mrdriller/didEventFirst'} BranchMacro ''>
        if slot_picked_mrdriller_day1 and not scene_picked_once_mrdriller:
            jump s_day2_mrdriller_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_mrdriller_day1} &&  ${scene:picked_once_mrdriller}', 'name': '_1', 'path': 'mrdriller/didEventLoop'} BranchMacro ''>
        if slot_picked_mrdriller_day1 and  scene_picked_once_mrdriller:
            jump s_day2_mrdriller_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_mrdriller_day1} && !${scene:picked_once_mrdriller}', 'name': '_2', 'path': 'mrdriller/didntEventFirst'} BranchMacro ''>
        if not slot_picked_mrdriller_day1 and not scene_picked_once_mrdriller:
            jump s_day2_mrdriller_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_mrdriller_day1} &&  ${scene:picked_once_mrdriller}', 'name': '_3', 'path': 'mrdriller/didntEventLoop'} BranchMacro ''>
        ...
        label s_day2_mrdriller_didntEventLoop:
            ...
            # <ParallelEvent {'auto': 'true', 'name': '_4'} ParallelEvent ''>
            # <Events {} events ''>
            ...
            # Blank text event <TextEvent {'auto': 'true', 'char': '', 'name': '_6', 'text': ''} TextEvent ''>
            # <ParallelEvent {'auto': 'true', 'name': '_7'} ParallelEvent ''>
            # <Events {} events ''>
            show i_sw_black as curtain zorder 15:
                # FadeEvent
                linear 0.3 alpha 0.0
    ...
    label s_day2_nidia:
        # <Macro {'name': 'nidia'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_nidia_day1} && !${scene:picked_once_nidia}', 'name': '_0', 'path': 'nidia/didEventFirst'} BranchMacro ''>
        if slot_picked_nidia_day1 and not scene_picked_once_nidia:
            jump s_day2_nidia_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_nidia_day1} &&  ${scene:picked_once_nidia}', 'name': '_1', 'path': 'nidia/didEventLoop'} BranchMacro ''>
        if slot_picked_nidia_day1 and  scene_picked_once_nidia:
            jump s_day2_nidia_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_nidia_day1} && !${scene:picked_once_nidia}', 'name': '_2', 'path': 'nidia/didntEventFirst'} BranchMacro ''>
        if not slot_picked_nidia_day1 and not scene_picked_once_nidia:
            jump s_day2_nidia_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_nidia_day1} &&  ${scene:picked_once_nidia}', 'name': '_3', 'path': 'nidia/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_richard:
        # <Macro {'name': 'richard'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_richard_day1} && !${scene:picked_once_richard}', 'name': '_0', 'path': 'richard/didEventFirst'} BranchMacro ''>
        if slot_picked_richard_day1 and not scene_picked_once_richard:
            jump s_day2_richard_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_richard_day1} &&  ${scene:picked_once_richard}', 'name': '_1', 'path': 'richard/didEventLoop'} BranchMacro ''>
        if slot_picked_richard_day1 and  scene_picked_once_richard:
            jump s_day2_richard_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_richard_day1} && !${scene:picked_once_richard}', 'name': '_2', 'path': 'richard/didntEventFirst'} BranchMacro ''>
        if not slot_picked_richard_day1 and not scene_picked_once_richard:
            jump s_day2_richard_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_richard_day1} &&  ${scene:picked_once_richard}', 'name': '_3', 'path': 'richard/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_taira:
        # <Macro {'name': 'taira'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_taira_day1} && !${scene:picked_once_taira}', 'name': '_0', 'path': 'taira/didEventFirst'} BranchMacro ''>
        if slot_picked_taira_day1 and not scene_picked_once_taira:
            jump s_day2_taira_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_taira_day1} &&  ${scene:picked_once_taira}', 'name': '_1', 'path': 'taira/didEventLoop'} BranchMacro ''>
        if slot_picked_taira_day1 and  scene_picked_once_taira:
            jump s_day2_taira_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_taira_day1} && !${scene:picked_once_taira}', 'name': '_2', 'path': 'taira/didntEventFirst'} BranchMacro ''>
        if not slot_picked_taira_day1 and not scene_picked_once_taira:
            jump s_day2_taira_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_taira_day1} &&  ${scene:picked_once_taira}', 'name': '_3', 'path': 'taira/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_terezi:
        # <Macro {'name': 'terezi'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_terezi_day1} && !${scene:picked_once_terezi}', 'name': '_0', 'path': 'terezi/didEventFirst'} BranchMacro ''>
        if slot_picked_terezi_day1 and not scene_picked_once_terezi:
            jump s_day2_terezi_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_terezi_day1} &&  ${scene:picked_once_terezi}', 'name': '_1', 'path': 'terezi/didEventLoop'} BranchMacro ''>
        if slot_picked_terezi_day1 and  scene_picked_once_terezi:
            jump s_day2_terezi_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_terezi_day1} && !${scene:picked_once_terezi}', 'name': '_2', 'path': 'terezi/didntEventFirst'} BranchMacro ''>
        if not slot_picked_terezi_day1 and not scene_picked_once_terezi:
            jump s_day2_terezi_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_terezi_day1} &&  ${scene:picked_once_terezi}', 'name': '_3', 'path': 'terezi/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_tomari:
        # <Macro {'name': 'tomari'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_tomari_day1} && !${scene:picked_once_tomari}', 'name': '_0', 'path': 'tomari/didEventFirst'} BranchMacro ''>
        if slot_picked_tomari_day1 and not scene_picked_once_tomari:
            jump s_day2_tomari_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_tomari_day1} &&  ${scene:picked_once_tomari}', 'name': '_1', 'path': 'tomari/didEventLoop'} BranchMacro ''>
        if slot_picked_tomari_day1 and  scene_picked_once_tomari:
            jump s_day2_tomari_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_tomari_day1} && !${scene:picked_once_tomari}', 'name': '_2', 'path': 'tomari/didntEventFirst'} BranchMacro ''>
        if not slot_picked_tomari_day1 and not scene_picked_once_tomari:
            jump s_day2_tomari_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_tomari_day1} &&  ${scene:picked_once_tomari}', 'name': '_3', 'path': 'tomari/didntEventLoop'} BranchMacro ''>
    ...
    label s_day2_valk:
        # <Macro {'name': 'valk'} Macro ''>
        # <Events {} events ''>
        # <BranchMacro {'comparison': '${slot:picked_valk_day1} && !${scene:picked_once_valk}', 'name': '_0', 'path': 'valk/didEventFirst'} BranchMacro ''>
        if slot_picked_valk_day1 and not scene_picked_once_valk:
            jump s_day2_valk_didEventFirst
        # <BranchMacro {'comparison': '${slot:picked_valk_day1} &&  ${scene:picked_once_valk}', 'name': '_1', 'path': 'valk/didEventLoop'} BranchMacro ''>
        if slot_picked_valk_day1 and  scene_picked_once_valk:
            jump s_day2_valk_didEventLoop
        # <BranchMacro {'comparison': '!${slot:picked_valk_day1} && !${scene:picked_once_valk}', 'name': '_2', 'path': 'valk/didntEventFirst'} BranchMacro ''>
        if not slot_picked_valk_day1 and not scene_picked_once_valk:
            jump s_day2_valk_didntEventFirst
        # <BranchMacro {'comparison': '!${slot:picked_valk_day1} &&  ${scene:picked_once_valk}', 'name': '_3', 'path': 'valk/didntEventLoop'} BranchMacro ''>
