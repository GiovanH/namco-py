...
# <Scene scene {'id': 's_day2.5', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance', 'kind': 'scene'} ''>
label s_day2p5:
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': 'day2.5initialize', 'kind': 'ParallelEvent'} ''>
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': 'day2.5prechoice', 'kind': 'ParallelEvent'} ''>
    ...
    label s_day2p5_albatros:
        ...
        if not scene_picked_once_albatros:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_albatros}', 'kind': 'IfFalse'} ''>
            label s_day2p5_albatros_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_albatros_day3}', 'name': '_B', 'path': 'albatros/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        if scene_picked_once_albatros:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_albatros}', 'kind': 'IfTrue'} ''>
            label s_day2p5_albatros_Loop:
                ...
                menu:
                    ...
                    "LEAVE AL TO THE BIRDS":
                        $ slot_picked_albatros_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_albatros_day3}', 'name': '_3', 'path': 'albatros/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_albatros_day3:
                    jump s_day2p5_albatros_Chosen
        ...
        label s_day2p5_albatros_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_2', 'scene': 's_albatros3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_amazona:
        ...
        if not scene_picked_once_amazona:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_amazona}', 'kind': 'IfFalse'} ''>
            label s_day2p5_amazona_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_amazona_day3}', 'name': '_6', 'path': 'amazona/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_amazona_day3:
                    jump s_day2p5_amazona_Chosen
                jump s_day2p5_amazona_Passed
        if scene_picked_once_amazona:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_amazona}', 'kind': 'IfTrue'} ''>
            label s_day2p5_amazona_Loop:
                ...
                menu:
                    ...
                    "I'm going to go.":
                        $ slot_picked_amazona_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_amazona_day3}', 'name': '_4', 'path': 'amazona/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_amazona_day3:
                    jump s_day2p5_amazona_Chosen
                jump s_day2p5_amazona_Passed
        # <Macro Macro {'name': 'Chosen', 'kind': 'Macro'} ''>
        label s_day2p5_amazona_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_8', 'scene': 's_amazona3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_antibravo:
        ...
        if not scene_picked_once_antibravo:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_antibravo}', 'kind': 'IfFalse'} ''>
            label s_day2p5_antibravo_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_antibravo_day3}', 'name': '_A', 'path': 'antibravo/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        if scene_picked_once_antibravo:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_antibravo}', 'kind': 'IfTrue'} ''>
            label s_day2p5_antibravo_Loop:
                ...
                menu:
                    ...
                    "Maybe not...":
                        $ slot_picked_antibravo_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_antibravo_day3}', 'name': '_4', 'path': 'antibravo/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_antibravo_day3:
                    jump s_day2p5_antibravo_Chosen
                jump s_day2p5_antibravo_Passed
        # <Macro Macro {'name': 'Chosen', 'kind': 'Macro'} ''>
        label s_day2p5_antibravo_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_5', 'scene': 's_antibravo3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_bluemax:
        ...
        if not scene_picked_once_bluemax:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_bluemax}', 'kind': 'IfFalse'} ''>
            label s_day2p5_bluemax_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_bluemax_day3}', 'name': '_4', 'path': 'bluemax/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        if scene_picked_once_bluemax:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_bluemax}', 'kind': 'IfTrue'} ''>
            label s_day2p5_bluemax_Loop:
                ...
                menu:
                    ...
                    "Forget it!":
                        $ slot_picked_bluemax_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_bluemax_day3}', 'name': '_3', 'path': 'bluemax/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_bluemax_day3:
                    jump s_day2p5_bluemax_Chosen
        ...
        label s_day2p5_bluemax_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_2', 'scene': 's_bluemax3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_cousin:
        ...
        if scene_doneExplore:
            ...
            label s_day2p5_cousin_bail:
                ...
                # <SettingChange SettingChange {'bgImage': '@i_bg_classroom_a', 'curtainFadeTime': '1', 'name': '_6', 'kind': 'SettingChange'} ''>
                # <Events events {'kind': 'events'} ''>
                show i_cousin_default_neutral as cousin:
                    # ShowWithAtl
                ...
                # <NHSceneChange NHSceneChange {'name': '_U', 'scene': 's_day4', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_davesprite:
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_davesprite_day3}', 'name': '_6', 'path': 'davesprite/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_davesprite_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_davesprite3', 'kind': 'NHSceneChange'} ''>
            label s_day2p5_davesprite_Chosen__1:
                # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_davesprite3', 'kind': 'NHSceneChange'} ''>
                jump s_davesprite3
        # <ParallelEvent ParallelEvent {'name': 'Passed', 'kind': 'ParallelEvent'} ''>
    ...
    label s_day2p5_donko:
        ...
        if not scene_picked_once_donko:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_donko}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_donko:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_donko}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_donko_day3}', 'name': '_3', 'path': 'donko/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_donko_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_donko3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_galaga:
        ...
        if not scene_picked_once_galaga:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_galaga}', 'kind': 'IfFalse'} ''>
            label s_day2p5_galaga_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_galaga_day3}', 'name': '_4', 'path': 'galaga/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        if scene_picked_once_galaga:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_galaga}', 'kind': 'IfTrue'} ''>
            label s_day2p5_galaga_Loop:
                ...
                menu:
                    ...
                    "DO NOT HELP GALAGA SHIP":
                        $ slot_picked_galaga_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_galaga_day3}', 'name': '_3', 'path': 'galaga/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_galaga_day3:
                    jump s_day2p5_galaga_Chosen
        ...
        label s_day2p5_galaga_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_4', 'scene': 's_galaga3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_hiromi:
        ...
        if not scene_picked_once_hiromi:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_hiromi}', 'kind': 'IfFalse'} ''>
            label s_day2p5_hiromi_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_hiromi_day3}', 'name': '_4', 'path': 'hiromi/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_hiromi_day3:
                    jump s_day2p5_hiromi_Chosen
                jump s_day2p5_hiromi_Passed
        if scene_picked_once_hiromi:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_hiromi}', 'kind': 'IfTrue'} ''>
            label s_day2p5_hiromi_Loop:
                ...
                menu:
                    ...
                    "Sounds kind of boring...":
                        $ slot_picked_hiromi_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_hiromi_day3}', 'name': '_5', 'path': 'hiromi/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_hiromi_day3:
                    jump s_day2p5_hiromi_Chosen
                jump s_day2p5_hiromi_Passed
        # <Macro Macro {'name': 'Chosen', 'kind': 'Macro'} ''>
        label s_day2p5_hiromi_Chosen:
            # <Macro Macro {'name': 'Chosen', 'kind': 'Macro'} ''>
            # <Events events {'kind': 'events'} ''>
            # <ParallelEvent ParallelEvent {'allowInterrupt': 'false', 'name': '_0', 'kind': 'ParallelEvent'} ''>
            # <Events events {'kind': 'events'} ''>
            show i_cousin_default_surprised as cousin
            ...
            # <NHSceneChange NHSceneChange {'name': '_5', 'scene': 's_hiromi3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_jane:
        ...
        if not scene_picked_once_jane:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_jane}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_jane:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_jane}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_jane_day3}', 'name': '_3', 'path': 'jane/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_jane_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_5', 'scene': 's_jane3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_lolo:
        ...
        if not scene_picked_once_lolo:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_lolo}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_lolo:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_lolo}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_lolo_day3}', 'name': '_3', 'path': 'lolo/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_lolo_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_lolo3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_meowkie:
        ...
        if not scene_picked_once_meowkie:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_meowkie}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_meowkie:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_meowkie}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_meowkie_day3}', 'name': '_3', 'path': 'meowkie/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_meowkie_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_meowkie3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_mrdriller:
        ...
        if not scene_picked_once_mrdriller:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_mrdriller}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_mrdriller:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_mrdriller}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_mrdriller_day3}', 'name': '_3', 'path': 'mrdriller/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_mrdriller_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_mrdriller3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_nidia:
        ...
        if not scene_picked_once_nidia:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_nidia}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_nidia:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_nidia}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_nidia_day3}', 'name': '_3', 'path': 'nidia/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_nidia_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_E', 'scene': 's_nidia3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_richard:
        ...
        if not scene_picked_once_richard:
            ...
            label s_day2p5_richard_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_richard_day3}', 'name': '_8', 'path': 'richard/ChosenFirstTime', 'kind': 'BranchMacro'} ''>
            ...
            label s_day2p5_richard_Loop:
                ...
                menu:
                    ...
                    "Nope, still too crazy!":
                        $ slot_picked_richard_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_richard_day3}', 'name': '_3', 'path': 'richard/ChosenLoop', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_richard_day3:
                    jump s_day2p5_richard_ChosenLoop
                jump s_day2p5_richard_PassedLoop
        # <Macro Macro {'name': 'ChosenFirstTime', 'kind': 'Macro'} ''>
        label s_day2p5_richard_ChosenFirstTime:
            ...
            # <NHSceneChange NHSceneChange {'name': '_5', 'scene': 's_richard3', 'kind': 'NHSceneChange'} ''>
        ...
        label s_day2p5_richard_ChosenLoop:
            ...
            $ slot_pick_count_richard += 1
            # <NHSceneChange NHSceneChange {'name': '_4', 'scene': 's_richard3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_taira:
        ...
        if not scene_picked_once_taira:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_taira}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_taira:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_taira}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_taira_day3}', 'name': '_3', 'path': 'taira/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_taira_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_1', 'scene': 's_taira3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_terezi:
        ...
        if not scene_picked_once_terezi:
            # <IfFalse IfFalse {'name': 'FirstTime', 'value': '${scene:picked_once_terezi}', 'kind': 'IfFalse'} ''>
        ...
        if scene_picked_once_terezi:
            # <IfTrue IfTrue {'name': 'Loop', 'value': '${scene:picked_once_terezi}', 'kind': 'IfTrue'} ''>
        ...
        # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_terezi_day3}', 'name': '_3', 'path': 'terezi/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        label s_day2p5_terezi_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_F', 'scene': 's_terezi3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_tomari:
        ...
        if not scene_picked_once_tomari:
            ...
            label s_day2p5_tomari_FirstTime:
                ...
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_tomari_day3}', 'name': '_4', 'path': 'tomari/Chosen', 'kind': 'BranchMacro'} ''>
        ...
        if scene_picked_once_tomari:
            ...
            label s_day2p5_tomari_Loop:
                ...
                menu:
                    ...
                    "Better skip it.":
                        $ slot_picked_tomari_day3 = False
                # <BranchMacro BranchMacro {'comparison': '!!${slot:picked_tomari_day3}', 'name': '_3', 'path': 'tomari/Chosen', 'kind': 'BranchMacro'} ''>
                if not not slot_picked_tomari_day3:
                    jump s_day2p5_tomari_Chosen
        ...
        label s_day2p5_tomari_Chosen:
            ...
            # <NHSceneChange NHSceneChange {'name': '_3', 'scene': 's_tomari3', 'kind': 'NHSceneChange'} ''>
    ...
    label s_day2p5_valk:
        ...
        if slot_picked_valk_day1:
            # <IfTrue IfTrue {'name': 'didEvent1', 'value': '${slot:picked_valk_day1}', 'kind': 'IfTrue'} ''>
            label s_day2p5_valk_didEvent1:
                ...
                if slot_picked_valk_day3:
                    # <IfTrue IfTrue {'name': 'Chosen', 'value': '${slot:picked_valk_day3}', 'kind': 'IfTrue'} ''>
                    label s_day2p5_valk_didEvent1_Chosen:
                        ...
                        # <NHSceneChange NHSceneChange {'name': '_7', 'scene': 's_valk3', 'kind': 'NHSceneChange'} ''>
        ...
        if not slot_picked_valk_day1:
            # <IfFalse IfFalse {'name': 'didntEvent1', 'value': '${slot:picked_valk_day1}', 'kind': 'IfFalse'} ''>
            label s_day2p5_valk_didntEvent1:
                ...
                if slot_picked_valk_day3:
                    ...
                    label s_day2p5_valk_didntEvent1_Chosen:
                        ...
                        $ slot_pick_count_valk += 1
                        # <NHSceneChange NHSceneChange {'name': '_5', 'scene': 's_valk3', 'kind': 'NHSceneChange'} ''>
