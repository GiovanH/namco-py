# <Scene scene {'id': 's_terezi3', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance', 'kind': 'scene'} ''>
label s_terezi3:
    ...
    # <SettingChange SettingChange {'bgActor': 'bg', 'bgImage': '@i_bg_cliff_night', 'curtainActor': 'curtain', 'curtainFadeTime': '0.75', 'name': '_2M', 'kind': 'SettingChange'} ''>
    # <Events events {'kind': 'events'} ''>
    show i_cousin_default_neutral as cousin:
        # ShowWithAtl
    ...
    # <NHSceneChange NHSceneChange {'name': '_2b', 'scene': 's_day4', 'kind': 'NHSceneChange'} ''>
    label s_terezi3__2b:
        # <NHSceneChange NHSceneChange {'name': '_2b', 'scene': 's_day4', 'kind': 'NHSceneChange'} ''>
        jump s_day4