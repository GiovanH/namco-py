...
# <Scene {'id': 's_bluemax6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_bluemax6:
    ...
    if slot_pick_count_bluemax <= 1:
        call BadEndMacro
    # <NormalEndMacro {'cousinX': '-5%', 'name': '_3', 'partnerActor': 'bluemax', 'partnerImage': '@i_bluemax_stand_smile', 'partnerX': '-35%'} NormalEndMacro ''>
    # <ParallelEvent {'auto': True} ParallelEvent ''>
    # <Events {'kind': 'events'} events ''>
    ...
    if slot_pick_count_bluemax >= 3:
        # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_bluemax}', 'name': '_6', 'rvalue': '3'} IfGTE ''>
        label s_bluemax6__6:
            # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_bluemax}', 'name': '_6', 'rvalue': '3'} IfGTE ''>
            # <Events {} events ''>
