# <Scene scene {'id': 's_intro', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance', 'kind': 'scene'} ''>
label s_intro:
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_5', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    show i_bg_school_front as bg:
        # ShowWithAtl
        linear 1 alpha 0.0
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_P', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_S', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_U', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    extend " Sports equipment, like wrestleballs and stuff…" # @t_sintro10.05 self.block='Last'
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_V', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    extend " {cps=*1.67}Desks...{/cps}" # @t_sintro10.06 self.block='Last'
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_W', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_Y', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    extend " {cps=*1.67}Really it was the whole marching band...{/cps}" # @t_sintro10.09 self.block='Last'
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_Z', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    show i_cousin_exhausted_sad as cousin
    extend " {cps=*1.67}Everyone watching the marching band...{/cps}" # @t_sintro10.10 self.block='Last'
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_a', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_mrdriller', 'appendSecond': 'false', 'cousinActor': 'cousin', 'cousinScaleX': '-1', 'cousinX': '20%', 'firstText': '@t_sintro23.00', 'lastActor': 'alt1', 'name': '_w', 'realActor': 'alt2', 'realImage': '@i_mrdriller_slumped_happy', 'secondText': '@t_sintro24.00', 'silActor': 'alt2_sil', 'silImage': '@i_mrdriller_slumped_smug_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_donko_akimbo_wink as alt1:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_taira', 'appendSecond': 'false', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro25.00', 'lastActor': 'alt2', 'name': '_x', 'realActor': 'alt1', 'realImage': '@i_taira_steveholt_happy', 'secondText': '@t_sintro26.00', 'silActor': 'alt1_sil', 'silImage': '@i_taira_steveholt_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_mrdriller_slumped_happy as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_aki', 'appendSecond': 'true', 'cousinActor': 'cousin', 'cousinScaleX': '-1', 'cousinX': '20%', 'firstText': '@t_sintro27.00', 'lastActor': 'alt1', 'name': '_y', 'realActor': 'alt2', 'realImage': '@i_aki_akimbo_focus', 'secondText': '@t_sintro27.01', 'silActor': 'alt2_sil', 'silImage': '@i_aki_akimbo_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_taira_steveholt_happy as alt1:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_max', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro28.00', 'lastActor': 'alt2', 'name': '_z', 'realActor': 'alt1', 'realImage': '@i_bluemax_cower_smile', 'silActor': 'alt1_sil', 'silImage': '@i_bluemax_cower_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_aki_akimbo_focus as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_valkyrie', 'cousinActor': 'cousin', 'cousinScaleX': '-1', 'cousinX': '20%', 'firstText': '@t_sintro29.00', 'lastActor': 'alt1', 'name': '_10', 'realActor': 'alt2', 'realImage': '@i_valkyrie_akimbo_bored', 'silActor': 'alt2_sil', 'silImage': '@i_valkyrie_akimbo_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_bluemax_cower_smile as alt1:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_meowkie', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro30.00', 'lastActor': 'alt2', 'name': '_11', 'realActor': 'alt1', 'realImage': '@i_meowkie_normal_forcedsmile_badge', 'silActor': 'alt1_sil', 'silImage': '@i_meowkie_normal_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_valkyrie_akimbo_bored as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_antibravo', 'actorScaleX': '0.95', 'actorScaleY': '0.95', 'actorY': '2.5%', 'cousinActor': 'cousin', 'cousinScaleX': '-1', 'cousinX': '20%', 'firstText': '@t_sintro31.00', 'lastActor': 'alt1', 'name': '_12', 'realActor': 'alt2', 'realImage': '@i_abm_backturned_broody', 'silActor': 'alt2_sil', 'silImage': '@i_abm_backturned_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_meowkie_normal_forcedsmile_badge as alt1:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_nidia', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro32.00', 'lastActor': 'alt2', 'name': '_13', 'realActor': 'alt1', 'realImage': '@i_nidia_akimbo_angry', 'silActor': 'alt1_sil', 'silImage': '@i_nidia_akimbo_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_abm_backturned_broody as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_lolo', 'actorScaleX': '0.9', 'actorScaleY': '0.9', 'actorY': '5%', 'cousinActor': 'cousin', 'cousinScaleX': '-1', 'cousinX': '20%', 'firstText': '@t_sintro33.00', 'lastActor': 'alt1', 'name': '_14', 'realActor': 'alt2', 'realImage': '@i_lolo_crossed_frustrated', 'silActor': 'alt2_sil', 'silImage': '@i_lolo_crossed_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_nidia_akimbo_angry as alt1:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_tomari', 'actorScaleX': '0.95', 'actorScaleY': '0.95', 'actorY': '2.5%', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro34.00', 'lastActor': 'alt2', 'name': '_15', 'realActor': 'alt1', 'realImage': '@i_tomari_pondering_thinking', 'silActor': 'alt1_sil', 'silImage': '@i_tomari_pondering_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_lolo_crossed_frustrated as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_hiromi', 'cousinActor': 'cousin', 'cousinScaleX': '-1', 'cousinX': '20%', 'firstText': '@t_sintro35.00', 'lastActor': 'alt1', 'name': '_16', 'realActor': 'alt2', 'realImage': '@i_hiromi_akimbo_serious', 'silActor': 'alt2_sil', 'silImage': '@i_hiromi_akimbo_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_tomari_pondering_thinking as alt1:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_albatros', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro36.00', 'lastActor': 'alt2', 'name': '_17', 'realActor': 'alt1', 'realImage': '@i_albatross_welcome_smirk_wink', 'silActor': 'alt1_sil', 'silImage': '@i_albatross_welcome_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_hiromi_akimbo_serious as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    $ renpy.pause(0.25, hard=True) # Image change
    ...
    $ renpy.pause(0.5, hard=True) # Text delay
    ...
    # <SilhouetteMacro SilhouetteMacro {'actorName': '@t_ch_galaga', 'cousinActor': 'cousin', 'cousinScaleX': '1', 'cousinX': '-20%', 'firstText': '@t_sintro38.00', 'lastActor': 'alt2', 'name': '_19', 'realActor': 'alt1', 'realImage': '@i_galaga_default', 'silActor': 'alt1_sil', 'silImage': '@i_galaga_default_sil', 'kind': 'SilhouetteMacro'} ''>
    show i_miller_aliens_serious as alt2:
        # ShowWithAtl
        linear 0.5 alpha 0.0
    ...
    # <ParallelEvent ParallelEvent {'auto': 'true', 'name': '_1I', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    show i_digdug_right as digdug:
        ...
        pause 1.0 
        linear 0.5 ypos 0.5 
    $ renpy.pause(1.5, hard=True) # TimedPause
    # <ParallelEvent ParallelEvent {'name': '_1l', 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    # <NHSceneChange NHSceneChange {'name': '_3V', 'scene': '@s_day0', 'kind': 'NHSceneChange'} ''>
    label s_intro__3V:
        # <NHSceneChange NHSceneChange {'name': '_3V', 'scene': '@s_day0', 'kind': 'NHSceneChange'} ''>
        jump s_day0