...
# <Scene {'id': 's_day0.5', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_day0p5:
    ...
    # Pass (assets)
    # <Events {} events ''>
    # <ParallelEvent {'auto': 'true', 'name': 'day0.5initialize'} ParallelEvent ''>
    ...
    # <ParallelEvent {'auto': 'true', 'name': 'day0.5prechoice'} ParallelEvent ''>
    ...
    label s_day0p5_albatros:
        ...
        if not scene_picked_once_albatros:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_albatros}'} IfFalse ''>
        ...
        if scene_picked_once_albatros:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_albatros}'} IfTrue ''>
            label s_day0p5_albatros_Loop:
                ...
                menu:
                    ...
                    "NO WAY THAT’S TOO DANGEROUS!":
                        $ slot_picked_albatros_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_albatros_day1}', 'name': '_2', 'path': 'albatros/Chosen'} BranchMacro ''>
        if not not slot_picked_albatros_day1:
            jump s_day0p5_albatros_Chosen
        # <BranchMacro {'comparison': '!!${scene:picked_once_albatros}', 'name': '_3', 'path': 'albatros/PassedLoop'} BranchMacro ''>
        ...
        label s_day0p5_albatros_Chosen:
            ...
            # <NHSceneChange {'name': '_7', 'scene': 's_albatros1'} NHSceneChange ''>
    ...
    label s_day0p5_amazona:
        ...
        if not scene_picked_once_amazona:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_amazona}'} IfFalse ''>
        ...
        if scene_picked_once_amazona:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_amazona}'} IfTrue ''>
            label s_day0p5_amazona_Loop:
                ...
                menu:
                    ...
                    "No":
                        $ slot_picked_amazona_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_amazona_day1}', 'name': '_2', 'path': 'amazona/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_amazona_Chosen:
            ...
            # <NHSceneChange {'name': '_E', 'scene': 's_amazona1'} NHSceneChange ''>
    ...
    label s_day0p5_antibravo:
        ...
        if not scene_picked_once_antibravo:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_antibravo}'} IfFalse ''>
        ...
        if scene_picked_once_antibravo:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_antibravo}'} IfTrue ''>
            label s_day0p5_antibravo_Loop:
                ...
                menu:
                    ...
                    "What club DO you recommend?":
                        $ slot_picked_antibravo_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_antibravo_day1}', 'name': '_2', 'path': 'antibravo/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_antibravo_Chosen:
            ...
            # <ParallelEvent {'allowInterrupt': 'false', 'name': '_F'} ParallelEvent ''>
            # <Events {} events ''>
            show i_cousin_default_neutral as cousin:
                # ShowWithAtl
            ...
            # <NHSceneChange {'name': '_I', 'scene': 's_antibravo1'} NHSceneChange ''>
    ...
    label s_day0p5_bluemax:
        ...
        if not scene_picked_once_bluemax:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_bluemax}'} IfFalse ''>
        ...
        if scene_picked_once_bluemax:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_bluemax}'} IfTrue ''>
            label s_day0p5_bluemax_Loop:
                ...
                menu:
                    ...
                    "Max is too nerdy for me!":
                        $ slot_picked_bluemax_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_bluemax_day1}', 'name': '_2', 'path': 'bluemax/Chosen'} BranchMacro ''>
        if not not slot_picked_bluemax_day1:
            jump s_day0p5_bluemax_Chosen
        # <BranchMacro {'comparison': '!!${scene:picked_once_bluemax}', 'name': '_3', 'path': 'bluemax/PassedLoop'} BranchMacro ''>
        ...
        label s_day0p5_bluemax_Chosen:
            ...
            # <NHSceneChange {'name': '_3', 'scene': 's_bluemax1'} NHSceneChange ''>
    ...
    label s_day0p5_cousin:
        ...
        if scene_doneExplore:
            ...
            label s_day0p5_cousin_bail:
                ...
                # <NHSceneChange {'name': '_7', 'scene': 's_day2'} NHSceneChange ''>
    ...
    label s_day0p5_davesprite:
        ...
        if not scene_picked_once_davesprite:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_davesprite}'} IfFalse ''>
        ...
        if scene_picked_once_davesprite:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_davesprite}'} IfTrue ''>
            label s_day0p5_davesprite_Loop:
                ...
                menu:
                    ...
                    "No":
                        $ slot_picked_davesprite_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_davesprite_day1}', 'name': '_2', 'path': 'davesprite/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_davesprite_Chosen:
            ...
            # <NHSceneChange {'name': '_3', 'scene': 's_davesprite1'} NHSceneChange ''>
    ...
    label s_day0p5_donko:
        ...
        if not scene_picked_once_donko:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_donko}'} IfFalse ''>
        ...
        if scene_picked_once_donko:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_donko}'} IfTrue ''>
            label s_day0p5_donko_Loop:
                ...
                menu:
                    ...
                    "I need some time!":
                        $ slot_picked_donko_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_donko_day1}', 'name': '_2', 'path': 'donko/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_donko_Chosen:
            ...
            # <NHSceneChange {'name': '_1', 'scene': 's_donko1'} NHSceneChange ''>
    ...
    label s_day0p5_galaga:
        ...
        if not scene_picked_once_galaga:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_galaga}'} IfFalse ''>
        ...
        if scene_picked_once_galaga:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_galaga}'} IfTrue ''>
            label s_day0p5_galaga_Loop:
                ...
                menu:
                    ...
                    "WAIT WHO AM I WHAT’S MY NAME AAAAAAH":
                        $ slot_picked_galaga_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_galaga_day1}', 'name': '_2', 'path': 'galaga/Chosen'} BranchMacro ''>
        if not not slot_picked_galaga_day1:
            jump s_day0p5_galaga_Chosen
        # <BranchMacro {'comparison': '!!${scene:picked_once_galaga}', 'name': '_3', 'path': 'galaga/PassedLoop'} BranchMacro ''>
        ...
        label s_day0p5_galaga_Chosen:
            ...
            # <NHSceneChange {'name': '_7', 'scene': 's_galaga1'} NHSceneChange ''>
    ...
    label s_day0p5_hiromi:
        ...
        if not scene_picked_once_hiromi:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_hiromi}'} IfFalse ''>
        ...
        if scene_picked_once_hiromi:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_hiromi}'} IfTrue ''>
            label s_day0p5_hiromi_Loop:
                ...
                menu:
                    ...
                    "Maybe next time...":
                        $ slot_picked_hiromi_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_hiromi_day1}', 'name': '_2', 'path': 'hiromi/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_hiromi_Chosen:
            ...
            # <NHSceneChange {'name': '_4', 'scene': 's_hiromi1'} NHSceneChange ''>
    ...
    label s_day0p5_jane:
        ...
        if not scene_picked_once_jane:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_jane}'} IfFalse ''>
        ...
        if scene_picked_once_jane:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_jane}'} IfTrue ''>
            label s_day0p5_jane_Loop:
                ...
                menu:
                    ...
                    "Let's look at other clubs first.":
                        $ slot_picked_jane_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_jane_day1}', 'name': '_2', 'path': 'jane/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_jane_Chosen:
            ...
            # <NHSceneChange {'name': '_2', 'scene': 's_jane1'} NHSceneChange ''>
    ...
    label s_day0p5_lolo:
        ...
        if not scene_picked_once_lolo:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_lolo}'} IfFalse ''>
        ...
        if scene_picked_once_lolo:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_lolo}'} IfTrue ''>
            label s_day0p5_lolo_Loop:
                ...
                menu:
                    ...
                    "I need some time to think about it...":
                        $ slot_picked_lolo_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_lolo_day1}', 'name': '_2', 'path': 'lolo/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_lolo_Chosen:
            ...
            # <NHSceneChange {'name': '_1', 'scene': 's_lolo1'} NHSceneChange ''>
    ...
    label s_day0p5_meowkie:
        ...
        if not scene_picked_once_meowkie:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_meowkie}'} IfFalse ''>
        ...
        if scene_picked_once_meowkie:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_meowkie}'} IfTrue ''>
            label s_day0p5_meowkie_Loop:
                ...
                menu:
                    ...
                    "Think it over":
                        $ slot_picked_meowkie_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_meowkie_day1}', 'name': '_2', 'path': 'meowkie/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_meowkie_Chosen:
            ...
            # <NHSceneChange {'name': '_5', 'scene': 's_meowkie1'} NHSceneChange ''>
    ...
    label s_day0p5_mrdriller:
        ...
        if not scene_picked_once_mrdriller:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_mrdriller}'} IfFalse ''>
        ...
        if scene_picked_once_mrdriller:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_mrdriller}'} IfTrue ''>
            label s_day0p5_mrdriller_Loop:
                ...
                menu:
                    ...
                    "I need some time to think about it.":
                        $ slot_picked_mrdriller_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_mrdriller_day1}', 'name': '_2', 'path': 'mrdriller/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_mrdriller_Chosen:
            ...
            # <NHSceneChange {'name': '_4', 'scene': 's_mrdriller1'} NHSceneChange ''>
    ...
    label s_day0p5_nidia:
        ...
        if not scene_picked_once_nidia:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_nidia}'} IfFalse ''>
        ...
        if scene_picked_once_nidia:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_nidia}'} IfTrue ''>
            label s_day0p5_nidia_Loop:
                ...
                menu:
                    ...
                    "I'm not really the world-saving type...sorry.":
                        $ slot_picked_nidia_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_nidia_day1}', 'name': '_2', 'path': 'nidia/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_nidia_Chosen:
            ...
            # <NHSceneChange {'name': '_4', 'scene': 's_nidia1'} NHSceneChange ''>
    ...
    label s_day0p5_richard:
        ...
        if scene_picked_once_richard:
            ...
            label s_day0p5_richard_Loop:
                ...
                # <ParallelEvent {'allowInterrupt': 'false', 'name': '_2'} ParallelEvent ''>
                # <Events {} events ''>
                ...
                menu:
                    ...
                    "Keep looking.":
                        $ slot_picked_richard_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_richard_day1}', 'name': '_2', 'path': 'richard/Chosen'} BranchMacro ''>
        if not not slot_picked_richard_day1:
            jump s_day0p5_richard_Chosen
        # <BranchMacro {'comparison': '!!${scene:picked_once_richard}', 'name': '_3', 'path': 'richard/PassedLoop'} BranchMacro ''>
        ...
        label s_day0p5_richard_Chosen:
            ...
            # <NHSceneChange {'name': '_4', 'scene': 's_richard1'} NHSceneChange ''>
    ...
    label s_day0p5_taira:
        ...
        if not scene_picked_once_taira:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_taira}'} IfFalse ''>
        ...
        if scene_picked_once_taira:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_taira}'} IfTrue ''>
            label s_day0p5_taira_Loop:
                ...
                menu:
                    ...
                    "I need some time to decide.":
                        $ slot_picked_taira_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_taira_day1}', 'name': '_2', 'path': 'taira/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_taira_Chosen:
            ...
            # <NHSceneChange {'name': '_1', 'scene': 's_taira1'} NHSceneChange ''>
    ...
    label s_day0p5_terezi:
        ...
        if not scene_picked_once_terezi:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_terezi}'} IfFalse ''>
        ...
        if scene_picked_once_terezi:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_terezi}'} IfTrue ''>
            label s_day0p5_terezi_Loop:
                ...
                menu:
                    ...
                    "No! Resist!":
                        $ slot_picked_terezi_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_terezi_day1}', 'name': '_2', 'path': 'terezi/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_terezi_Chosen:
            ...
            # <NHSceneChange {'name': '_5', 'scene': 's_terezi1'} NHSceneChange ''>
    ...
    label s_day0p5_tomari:
        ...
        if scene_picked_once_tomari:
            ...
            label s_day0p5_tomari_Loop:
                ...
                menu:
                    ...
                    "No way!!!":
                        $ slot_picked_tomari_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_tomari_day1}', 'name': '_2', 'path': 'tomari/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_tomari_Chosen:
            ...
            # <NHSceneChange {'name': '_3', 'scene': 's_tomari1'} NHSceneChange ''>
    ...
    label s_day0p5_valk:
        ...
        if not scene_picked_once_valk:
            # <IfFalse {'auto': 'true', 'name': 'FirstTime', 'value': '${scene:picked_once_valk}'} IfFalse ''>
        ...
        if scene_picked_once_valk:
            # <IfTrue {'auto': 'true', 'name': 'Loop', 'value': '${scene:picked_once_valk}'} IfTrue ''>
            label s_day0p5_valk_Loop:
                ...
                menu:
                    ...
                    "I'm terrible at dates-- I MEAN WOOD SHOP":
                        $ slot_picked_valk_day1 = False
        # <BranchMacro {'comparison': '!!${slot:picked_valk_day1}', 'name': '_2', 'path': 'valk/Chosen'} BranchMacro ''>
        ...
        label s_day0p5_valk_Chosen:
            ...
            # <NHSceneChange {'name': '_3', 'scene': 's_valk1'} NHSceneChange ''>
