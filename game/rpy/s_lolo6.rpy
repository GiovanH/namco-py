...
# <Scene {'id': 's_lolo6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_lolo6:
    ...
    # <BattleMacro {'name': '_1', 'partnerActor': 'lolo'} BattleMacro ''>
    ...
    if slot_pick_count_lolo >= 3:
        # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_lolo}', 'name': '_L', 'rvalue': '3'} IfGTE ''>
        label s_lolo6__L:
            # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_lolo}', 'name': '_L', 'rvalue': '3'} IfGTE ''>
            # <Events {} events ''>
