...
# <Scene {'id': 's_tomari6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_tomari6:
    ...
    # <BattleMacro {'name': '_1', 'partnerActor': 'tomari'} BattleMacro ''>
    ...
    if slot_pick_count_tomari >= 3:
        # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_tomari}', 'name': '_B', 'rvalue': '3'} IfGTE ''>
        label s_tomari6__B:
            # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_tomari}', 'name': '_B', 'rvalue': '3'} IfGTE ''>
            # <Events {} events ''>
