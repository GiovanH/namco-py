# <Scene {'id': 's_taira5', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_taira5:
    ...
    # <SettingChange {'bgActor': 'bg', 'bgImage': '@i_bg_quad_bleachers', 'curtainActor': 'curtain', 'curtainFadeTime': '1', 'name': '_R'} SettingChange ''>
    show i_sw_black as curtain:
        alpha 1.0
    ...
    # <ParallelEvent {'allowInterrupt': 'false', 'auto': 'true', 'name': '_3d'} ParallelEvent ''>
    # <Events {} events ''>
    show i_pacman_left as pacman:
        # ShowWithAtl
        ease_expo 4 xpos 0.8 
    $ renpy.pause(4.0) # TimedPause
    stop sound
    # <ParallelEvent {'name': '_3f'} ParallelEvent ''>
    # <Events {} events ''>
    show i_cousin_default_surprised as cousin
    ...
    # <NHSceneChange {'name': '_43', 'scene': 's_day5.5'} NHSceneChange ''>
    label s_taira5__43:
        # <NHSceneChange {'name': '_43', 'scene': 's_day5.5'} NHSceneChange ''>
        jump s_day5p5