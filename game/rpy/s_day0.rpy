...
# <Scene {'id': 's_day0', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_day0:
    ...
    # Pass (assets)
    # <Events {} events ''>
    # <ParallelEvent {'auto': 'true', 'name': 'day0initialize'} ParallelEvent ''>
    ...
    # <ParallelEvent {'auto': 'true', 'name': 'day0prechoice'} ParallelEvent ''>
    ...
    label s_day0_amazona:
        ...
        # <ParallelEvent {'allowInterrupt': 'false', 'name': '_R'} ParallelEvent ''>
        # <Events {} events ''>
        show i_aki_akimbo_laughter as aki:
            # FadeEvent
    ...
    label s_day0_cousin:
        ...
        if scene_doneExplore:
            ...
            label s_day0_cousin_bail:
                ...
                # <NHSceneChange {'name': '_2', 'scene': 's_day0.5'} NHSceneChange ''>
    ...
    label s_day0_davesprite:
        ...
        if not scene_picked_once_davesprite:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_davesprite}'} IfFalse ''>
            label s_day0_davesprite_firstDialouge:
                ...
                if persistent.got_trueend_davesprite:
                    # <IfTrue {'name': '_3', 'value': '${game:got_trueend_davesprite}'} IfTrue ''>
        ...
        if scene_picked_once_davesprite:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_davesprite}'} IfTrue ''>
    ...
    label s_day0_donko:
        ...
        if not scene_picked_once_donko:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_donko}'} IfFalse ''>
        ...
        if scene_picked_once_donko:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_donko}'} IfTrue ''>
    ...
    label s_day0_galaga:
        ...
        # <ParallelEvent {'allowInterrupt': 'false', 'auto': 'true', 'name': '_J'} ParallelEvent ''>
        # <Events {} events ''>
        show i_donko_default_meloncholic as donko:
            pause 1
            linear .3 xzoom 0.85 
        ...
        # <ParallelEvent {'allowInterrupt': 'false', 'auto': 'true', 'name': '_O'} ParallelEvent ''>
        # <Events {} events ''>
        show i_donko_akimbo_meloncholic as donko:
            # ShowWithAtl
            pause 0.5 
    ...
    label s_day0_jane:
        ...
        if not scene_picked_once_jane:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_jane}'} IfFalse ''>
        ...
        if scene_picked_once_jane:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_jane}'} IfTrue ''>
    ...
    label s_day0_lolo:
        ...
        if not scene_picked_once_lolo:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_lolo}'} IfFalse ''>
        ...
        if scene_picked_once_lolo:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_lolo}'} IfTrue ''>
    ...
    label s_day0_meowkie:
        ...
        if not scene_picked_once_meowkie:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_meowkie}'} IfFalse ''>
        ...
        if scene_picked_once_meowkie:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_meowkie}'} IfTrue ''>
    ...
    label s_day0_taira:
        ...
        if not scene_picked_once_taira:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_taira}'} IfFalse ''>
        ...
        if scene_picked_once_taira:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_taira}'} IfTrue ''>
    ...
    label s_day0_terezi:
        ...
        if not scene_picked_once_terezi:
            # <IfFalse {'name': 'firstDialouge', 'value': '${scene:picked_once_terezi}'} IfFalse ''>
        ...
        if scene_picked_once_terezi:
            # <IfTrue {'name': 'loopDialogue', 'value': '${scene:picked_once_terezi}'} IfTrue ''>
