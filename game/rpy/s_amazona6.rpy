...
# <Scene {'id': 's_amazona6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_amazona6:
    ...
    # <BattleMacro {'name': '_1', 'partnerActor': 'amazona'} BattleMacro ''>
    ...
    if slot_pick_count_amazona <= 1:
        call BadEndMacro
    # <NormalEndMacro {'cousinX': '-15%', 'name': '_3', 'partnerActor': 'amazona', 'partnerImage': '@i_amazona_akimbo_smile', 'partnerX': '-35%'} NormalEndMacro ''>
    # <ParallelEvent {'auto': True} ParallelEvent ''>
    # <Events {'kind': 'events'} events ''>
    ...
    if slot_pick_count_amazona >= 3:
        # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_amazona}', 'name': '_6', 'rvalue': '3'} IfGTE ''>
        label s_amazona6__6:
            # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_amazona}', 'name': '_6', 'rvalue': '3'} IfGTE ''>
            # <Events {} events ''>
