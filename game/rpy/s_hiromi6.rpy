...
# <Scene {'id': 's_hiromi6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_hiromi6:
    ...
    if slot_pick_count_hiromi <= 1:
        # <IfLTE {'auto': 'true', 'lvalue': '${slot:pick_count_hiromi}', 'name': '_1', 'rvalue': '1'} IfLTE ''>
        label s_hiromi6__1:
            # <IfLTE {'auto': 'true', 'lvalue': '${slot:pick_count_hiromi}', 'name': '_1', 'rvalue': '1'} IfLTE ''>
            # <Events {} events ''>
            show i_battlepose_hiromi_notoby as hiromi
    # <BattleMacro {'name': '_2', 'partnerActor': 'hiromi'} BattleMacro ''>
    ...
    if slot_pick_count_hiromi == 2:
        # <IfEqual {'lvalue': '${slot:pick_count_hiromi}', 'name': '_5', 'rvalue': '2'} IfEqual ''>
        label s_hiromi6__5:
            # <IfEqual {'lvalue': '${slot:pick_count_hiromi}', 'name': '_5', 'rvalue': '2'} IfEqual ''>
            # <Events {} events ''>
