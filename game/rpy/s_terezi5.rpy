# <Scene {'id': 's_terezi5', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_terezi5:
    ...
    # <ParallelEvent {'allowInterrupt': 'false', 'auto': 'true', 'name': '_28'} ParallelEvent ''>
    # <Events {} events ''>
    ...
    # <ParallelEvent {'allowInterrupt': 'false', 'auto': 'true', 'name': '_2G'} ParallelEvent ''>
    # <Events {} events ''>
    show i_pacman_left as pacman:
        # ShowWithAtl
        linear 3 xpos 1.5 
    ...
    # <NHSceneChange {'name': '_2P', 'scene': 's_day5.5'} NHSceneChange ''>
    label s_terezi5__2P:
        # <NHSceneChange {'name': '_2P', 'scene': 's_day5.5'} NHSceneChange ''>
        jump s_day5p5