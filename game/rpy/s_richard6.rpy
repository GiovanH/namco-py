...
# <Scene scene {'id': 's_richard6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance', 'kind': 'scene'} ''>
label s_richard6:
    ...
    # <BattleMacro BattleMacro {'name': '_1', 'partnerActor': 'miller', 'kind': 'BattleMacro'} ''>
    window hide None
    ...
    if slot_pick_count_richard <= 1:
        call BadEndMacro
    # <NormalEndMacro NormalEndMacro {'cousinX': '-5%', 'name': '_3', 'partnerActor': 'miller', 'partnerImage': '@i_miller_standing_laugh', 'kind': 'NormalEndMacro'} ''>
    # <ParallelEvent ParallelEvent {'auto': True, 'kind': 'ParallelEvent'} ''>
    # <Events events {'kind': 'events'} ''>
    ...
    if slot_pick_count_richard >= 3:
        # <IfGTE IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_richard}', 'name': '_6', 'rvalue': '3', 'kind': 'IfGTE'} ''>
        label s_richard6__6:
            # <IfGTE IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_richard}', 'name': '_6', 'rvalue': '3', 'kind': 'IfGTE'} ''>
            # <Events events {'kind': 'events'} ''>
            ...
            show i_event_miller_ending as trueEnd zorder 18:
                ...
                alpha 0.0
                linear 1 alpha 1.0
            # <ParallelEvent ParallelEvent {'allowInterrupt': 'false', 'auto': 'true', 'name': '_2', 'kind': 'ParallelEvent'} ''>
            # <Events events {'kind': 'events'} ''>
            show i_sw_black as curtain:
                # ShowWithAtl
                linear 0.5 alpha 0.0
