...
# <Scene {'id': 's_antibravo6', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_antibravo6:
    ...
    # <BattleMacro {'name': '_1', 'partnerActor': 'antibravo'} BattleMacro ''>
    ...
    if slot_pick_count_antibravo <= 1:
        call BadEndMacro
    # <NormalEndMacro {'cousinX': '-10%', 'name': '_3', 'partnerActor': 'antibravo', 'partnerImage': '@i_abm_backturned_grin', 'partnerX': '-40%'} NormalEndMacro ''>
    # <ParallelEvent {'auto': True} ParallelEvent ''>
    # <Events {'kind': 'events'} events ''>
    ...
    if slot_pick_count_antibravo >= 3:
        # <IfGTE {'auto': 'true', 'lvalue': '${slot:pick_count_antibravo}', 'name': '_6', 'rvalue': '3'} IfGTE ''>
