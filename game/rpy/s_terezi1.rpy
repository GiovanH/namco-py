# <Scene {'id': 's_terezi1', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_terezi1:
    ...
    # <SettingChange {'bgActor': 'bg', 'bgImage': '@i_bg_hallway_b', 'curtainActor': 'curtain', 'curtainFadeTime': '.75', 'name': '_2P'} SettingChange ''>
    # <Events {} events ''>
    show i_cousin_default_neutral as cousin:
        # ShowWithAtl
        linear 0.5 xpos 0.3 
    ...
    # <NHSceneChange {'name': '_2j', 'scene': 's_day2'} NHSceneChange ''>
    label s_terezi1__2j:
        # <NHSceneChange {'name': '_2j', 'scene': 's_day2'} NHSceneChange ''>
        jump s_day2