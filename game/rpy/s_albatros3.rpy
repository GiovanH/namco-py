# <Scene {'id': 's_albatros3', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'} scene ''>
label s_albatros3:
    ...
    # <SettingChange {'bgActor': 'bg', 'bgImage': '@i_bg_cafe', 'curtainActor': 'curtain', 'curtainFadeTime': '1', 'name': '_1C'} SettingChange ''>
    # <Events {} events ''>
    ...
    # <NHSceneChange {'name': '_3k', 'scene': 's_day4'} NHSceneChange ''>
