# <Scene scene {'id': 's_jane5', 'xsi:schemaLocation': 'http://datenighto.com/schemas/htmlvn/0.1 ./htmlvn.xsd', 'xmlns': 'http://datenighto.com/schemas/htmlvn/0.1', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance', 'kind': 'scene'} ''>
label s_jane5:
    ...
    # <NHSceneChange NHSceneChange {'name': '_1w', 'scene': 's_day5.5', 'kind': 'NHSceneChange'} ''>
    label s_jane5__1w:
        # <NHSceneChange NHSceneChange {'name': '_1w', 'scene': 's_day5.5', 'kind': 'NHSceneChange'} ''>
        jump s_day5p5