...
define gui.choice_button_width = 618
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(79, 4, 79, 4)
...
define gui.slot_button_width = 216
define gui.slot_button_height = 161
...
define config.thumbnail_width = 200
define config.thumbnail_height = 113
...
## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.nvl_name_xpos = 336
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 118
define gui.nvl_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.nvl_text_xpos = 352
define gui.nvl_text_ypos = 7
define gui.nvl_text_width = 461
define gui.nvl_text_xalign = 0.0

## The position, width, and alignment of nvl_thought text (the text said by the
## nvl_narrator character.)
define gui.nvl_thought_xpos = 188
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 610
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 352
...
init python:
    ...
    if renpy.variant("touch"):
        ...
        gui.quick_button_borders = Borders(32, 11, 32, 0)
    ...
    if renpy.variant("small"):
        ...
        gui.label_text_size = 27

        ## Adjust the location of the textbox.
        gui.textbox_height = 188
        gui.name_xpos = 63
        gui.text_xpos = 71
        gui.text_width = 860
        ...
        gui.choice_button_width = 969

        gui.navigation_spacing = 16
        gui.pref_button_spacing = 8

        gui.history_height = 149
        gui.history_text_width = 540
        ...
        gui.nvl_name_width = 239
        gui.nvl_name_xpos = 254

        gui.nvl_text_width = 715
        gui.nvl_text_xpos = 270
        gui.nvl_text_ypos = 4

        gui.nvl_thought_width = 969
        gui.nvl_thought_xpos = 16

        gui.nvl_button_width = 969
